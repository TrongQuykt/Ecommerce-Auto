...
{
    [DbContext(typeof(DataCarContext))]
    partial class DataCarContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StoreCars.Models.Account", b =>
                {
            ...
            modelBuilder.Entity("StoreCars.Models.AccountType", b =>
                {
                    b.Property<int>("AccountTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StoreCars.Models.Address", b =>
                {
            ...
            modelBuilder.Entity("StoreCars.Models.Discount", b =>
                {
            ...
            modelBuilder.Entity("StoreCars.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StoreCars.Models.Oder", b =>
                {
                    b.Property<int>("OdersId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OdersId"));
            ...
            modelBuilder.Entity("StoreCars.Models.OderItem", b =>
                {
            ...
            modelBuilder.Entity("StoreCars.Models.Payment", b =>
                {
            ...
            modelBuilder.Entity("StoreCars.Models.PaymentMethod", b =>
                {
                    b.Property<int>("PaymentMethodsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StoreCars.Models.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StoreCars.Models.ProductType", b =>
                {
                    b.Property<int>("ProductTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StoreCars.Models.ProductsInventory", b =>
                {
                    b.Property<int>("ProductInventoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StoreCars.Models.ReceiptProduct", b =>
                {
            ...
            modelBuilder.Entity("StoreCars.Models.Role", b =>
                {
                    b.Property<int>("RoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StoreCars.Models.Shipment", b =>
                {
                    b.Property<int>("ShipmentsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StoreCars.Models.ShippingMethod", b =>
                {
                    b.Property<int>("ShippingMethodsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ShippingMethodsId"));
            ...
            modelBuilder.Entity("StoreCars.Models.Account", b =>
                {
                    b.HasOne("StoreCars.Models.AccountType", "AccountType")
                        .WithMany("Accounts")
                        .HasForeignKey("AccountTypeId")
                        .HasConstraintName("FK_Account_AccountType");

                    b.HasOne("StoreCars.Models.Role", "Role")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("StoreCars.Models.Address", b =>
                {
                    b.HasOne("StoreCars.Models.Account", "Account")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("StoreCars.Models.Message", b =>
                {
                    b.HasOne("StoreCars.Models.Account", "FromUser")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("StoreCars.Models.Oder", b =>
                {
                    ...
                    b.HasOne("StoreCars.Models.Discount", "Discount")
                        .WithMany("Oders")
            ...
            modelBuilder.Entity("StoreCars.Models.OderItem", b =>
                {
                    b.HasOne("StoreCars.Models.Oder", "Oder")
                        .WithMany("OderItems")
                        .HasForeignKey("OderId")
                        .IsRequired()
                        .HasConstraintName("FK_Oder_Items_Oders");

                    b.HasOne("StoreCars.Models.Product", "Product")
                        .WithMany("OderItems")
            ...
            modelBuilder.Entity("StoreCars.Models.Payment", b =>
                {
                    b.HasOne("StoreCars.Models.Oder", "Oders")
                        .WithMany("Payments")
                        .HasForeignKey("OdersId")
                        .HasConstraintName("FK_Payments_Oders");

                    b.HasOne("StoreCars.Models.PaymentMethod", "PaymentMethods")
                        .WithMany("Payments")
                        .HasForeignKey("PaymentMethodsId")
                        .HasConstraintName("FK_Payments_PaymentMethods");

                    b.HasOne("StoreCars.Models.Shipment", "Shipments")
                        .WithOne()
                        .HasForeignKey("StoreCars.Models.Payment", "ShipmentsId")
            ...
            modelBuilder.Entity("StoreCars.Models.Product", b =>
                {
                    b.HasOne("StoreCars.Models.ProductsInventory", "ProductInventory")
                        .WithMany("Products")
                        .HasForeignKey("ProductInventoryId")
                        .HasConstraintName("FK_Product_Product_Inventory");

                    b.HasOne("StoreCars.Models.ProductType", "ProductType")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("StoreCars.Models.Shipment", b =>
                {
                    ...
                    b.HasOne("StoreCars.Models.ShippingMethod", "ShippingMethods")
                        .WithMany("Shipments")
