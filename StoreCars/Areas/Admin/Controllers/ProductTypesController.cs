...
namespace StoreCars.Areas.Admin.Controllers
{
    ...
    public class ProductTypesController : Controller
    {
        ...
        public ProductTypesController(DataCarContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            return _context.ProductTypes != null ?
                        ...
                        Problem("Entity set 'DataCarContext.ProductTypes'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DataCarContext.ProductTypes'  is null.");
            }
            var productType = await _context.ProductTypes.FindAsync(id);
            if (productType != null)
            {
