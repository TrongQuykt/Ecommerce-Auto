...
namespace StoreCars.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(DataCarContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["ProductInventoryId"] = new SelectList(_context.ProductsInventorys, "ProductInventoryId", "Name", product.ProductInventoryId);
        ...
        public async Task<IActionResult> Edit(Product product, IFormFile fAvatar, IFormFile fAvatar1, IFormFile fAvatar2, IFormFile fAvatar3)
        {
            ...
            try
            {
                ...
                // ... Handle other image uploads similarly ...
                if (fAvatar1 != null)
                {
                    string extennsion = Path.GetExtension(fAvatar1.FileName);
                    image = Utilities.ToUrlFriendly(ConvertToSlug(product.Name + "1")) + extennsion;
                ...
                productex.Price = product.Price;
                productex.Status = product.Status;
                productex.ProductTypeId = product.ProductTypeId;
                productex.ProductInventoryId = product.ProductInventoryId;
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DataCarContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
