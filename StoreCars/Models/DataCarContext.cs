...
namespace StoreCars.Models
{
    public partial class DataCarContext : DbContext
    {
        public DataCarContext()
        {
        }

        public DataCarContext(DbContextOptions<DataCarContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=DESKTOP-GP1UH55\\SQLEXPRESS;Database=WebBanOto;Trusted_Connection=True;");
            }
        }
